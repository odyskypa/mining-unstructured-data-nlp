...
def compute_features(X_train, 
  ...
  # unigramVectorizer.fit_transform transforms the sentences into a matrix
  # with number of rows equal to the sentences
  # and each column is one of the top 1000 words appear
  # in the sentences
  # the max_features of words with the number of occurrences
  X_unigram_train_raw = unigramVectorizer.fit_transform(X_train)
  X_unigram_test_raw = unigramVectorizer.transform(X_test)
  # unigramVectorizer.get_feature_names keeps the 1000 most used words
